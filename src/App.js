...
function App() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setConnected(false);
      analyzeSentimentLocally(inputText); 
    } finally {
      setLoading(false); 
    }
  };
    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <label>
          ...
          <textarea value={inputText} onChange={(e) => setInputText(e.target.value)} placeholder="Type something..." />
        </label>
